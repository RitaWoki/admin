<template>
    <section>
        ...
        <el-row >
            <el-col :span="24">
                <el-card>
                        <el-table :data="orderTickets" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
        ...
        <el-dialog title="Edit Order Ticket" v-model="editFormVisible" :close-on-click-modal="false">
...
<script>
    ...
    import {removeUser, batchRemoveUser, getOrdersTickets,editOrderTickets} from '../../api/api';
