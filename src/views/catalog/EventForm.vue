                    ...
                    <el-tabs type="card" @tab-click="handleClick">
                        ...
                        <el-col :sm="24" :xs="24" :md="24" :lg="12">
                            <el-form labelPosition="left" ref="productInformation" :rules="productFormRules"
                                ...
                                <el-form-item label="Location" prop="manufacturer_id">
                                ...
                                <el-form-item>
                                    ...
                                    <el-button type="primary" @click="savProductInformation"
                        ...
                        <el-tab-pane label="Ticket Options">
                            <el-row :gutter="20">
                                <el-col :xs="24" :sm="24" :md="24" :lg="12">
                                    <el-form ref="form" :model="eventOptionForm" label-width="120px"
                                             labelPosition="left">
                                        <el-form-item label="Name">
                                            <el-input v-model="eventOptionForm.name"></el-input>
                                        </el-form-item>
                                        <el-form-item label="Option">
                                            <el-select v-model="eventOptionForm.option_id"
                                                       placeholder="please select your option">
                                                <el-option label="VVip" value="shanghai"></el-option>
                                                <el-option label="Vip" value="beijing"></el-option>
                                                <el-option label="Reg" value="beijing"></el-option>
                                            </el-select>
                                        </el-form-item>
                                        <el-form-item label="Tickets">
                                            <el-input-number placeholder="tickets"></el-input-number>
                                        </el-form-item>
                                        <el-form-item label="Required">
                                            <el-switch on-text="" off-text=""
                                                       v-model="eventOptionForm.status"></el-switch>
                                        </el-form-item>
                                        <el-form-item label="Price">
                                            <el-input v-model="eventOptionForm.price"
                                ...
                                <el-col :xs="24" :sm="24" :md="24" :lg="12">
                                    <el-table height="250"
                                        ...
                                        <el-table-column prop="description" label="Tickets" width="200">
                                        </el-table-column>
